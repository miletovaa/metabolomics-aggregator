...
class SampleSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $samples = [
            ...
            [
                'lab_sample_id' => 'LAB-0004',
                'external_id' => 'EXT-WATER-01',
                'matrix_group' => 'Surface water',
                'sample_group' => 'environment',
                'sample_subgroup' => 'water',
                'date_received' => '2026-04-08',
                'storage_condition' => 'refrigerated',
                'storage_condition_details' => ['dark'],
                'project_id' => null,
                'purpose_of_analysis' => ['pollution_assessment', 'monitoring'],
                'planned_analysis' => ['d2h', 'd18o'],
                'sample_type' => 'environmental',
                'type_details' => [
                    'depth' => '0.5 m',
                    'temperature_at_sampling' => '14.2 °C',
                    'ph' => '7.8',
                    'conductivity' => '512 µS/cm',
                ],
                'sampling' => [
                    'date_of_sampling' => '2026-04-08',
                    'country_of_sampling' => 'Slovenia',
                    'place_of_sampling' => 'Sava river, Ljubljana',
                    'gps_lat' => 46.0569,
                    'gps_lon' => 14.5058,
                    'altitude' => 265.0,
                    'sampling_method' => 'spot_sampling',
                    'packaging' => 'amber_glass_bottles',
                    'collector' => 'Ana Kos',
                ],
            ],
            [
                'lab_sample_id' => 'LAB-0005',
                'external_id' => 'EXT-SOIL-01',
                'matrix_group' => 'Topsoil',
                'sample_group' => 'environment',
                'sample_subgroup' => 'soil',
                'date_received' => '2026-04-09',
                'storage_condition' => 'dark_room_temp',
                'storage_condition_details' => ['dry'],
                'project_id' => null,
                'purpose_of_analysis' => ['pollution_assessment'],
                'planned_analysis' => ['elemental_composition'],
                'sample_type' => 'environmental',
                'type_details' => [
                    'depth' => '0-20 cm',
                    'temperature_at_sampling' => '11.5 °C',
                    'ph' => '6.4',
                ],
                'sampling' => [
                    'date_of_sampling' => '2026-04-09',
                    'country_of_sampling' => 'Slovenia',
                    'place_of_sampling' => 'Celje industrial zone',
                    'gps_lat' => 46.2311,
                    'gps_lon' => 15.2683,
                    'altitude' => 244.0,
                    'sampling_method' => 'core_sampling',
                    'packaging' => 'plastic_bags',
                    'collector' => 'Ana Kos',
                ],
            ],
