    ...
    <section class="mb-10">
        ...
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <x-dashboard-tile :href="route('experiments.index')" title="Experiments"
                ...
                :meta="Str::plural('experiment', $experimentsCount).': '.$experimentsCount">
                <x-slot name="icon">
                    <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <x-dashboard-tile :href="route('samples.index')" title="Samples"
                ...
                :meta="Str::plural('sample', $samplesCount).': '.$samplesCount">
                <x-slot name="icon">
                    <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <x-dashboard-tile :href="route('samplings.index')" title="Samplings"
                description="Collection-event details for samples: when, where, how, and by whom."
                :meta="Str::plural('sampling', $samplingsCount).': '.$samplingsCount">
                <x-slot name="icon">
                    <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
